...
echo "Installing skills for GPT Codex..."
...
for skill_dir in "$SOURCE_DIR"/*; do
  ...
  if [ -d "$TARGET_DIR/$skill_name" ]; then
    ...
    echo "Backing up existing skill: $skill_name -> $backup_dir"
...
echo "Target: $TARGET_DIR"
echo ""
echo "Restart Codex or reload your session if the skills do not appear immediately."